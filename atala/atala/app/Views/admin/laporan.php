                ...
                <div class="col-sm-4">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>Pengolahan Laporan Data Analisa</strong>
                        </li>
                    </ol>
                </div>
            </div>
                                            ...
                                            foreach ($data as $d) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center" width="10%">
                                                        <?php if($a == $b && $b > 0){ ?>
                                                            <a class="btn btn-primary btn-sm" href="<?php echo base_url('laporan/cetak/'.$d['kodeproyek']) ?>" target="blank">Cetak Laporan</a>
                                                        <?php }else{ ?>

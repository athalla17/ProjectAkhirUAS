                                        ...
                                        <tbody>
                                            <?php foreach ($data as $d) {?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $d['kriteria']." (".$d['kategori'].")" ?></td>
                        ...
                        <div class="col-lg-10">
                            <select class="form-control form-control-sm" name="kriteria" required>
                                <?php foreach ($kriteria as $k) {?>
                                    <option value="<?php echo $k['kodekriteria'] ?>"><?php echo $k['kriteria']." (".$k['kategori'].")" ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row"><label class="col-lg-2 col-form-label">Kriteria</label>
                            <div class="col-lg-10">
                                <select class="form-control form-control-sm" name="kriteria" required>
                                    <?php foreach ($kriteria as $k) {?>
                                        <option <?php if($d['kodekriteria'] == $k['kodekriteria']){echo "selected";} ?> value="<?php echo $k['kodekriteria'] ?>"><?php echo $k['kriteria']." (".$k['kategori'].")" ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
